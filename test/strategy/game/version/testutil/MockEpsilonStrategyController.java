...
/**
 * Provides a mock epsilon strategy controller for testing purposes
 * @author cbotaish, drob
 */
public class MockEpsilonStrategyController implements StrategyGameController {
	...
	public MockEpsilonStrategyController(Collection<PieceLocationDescriptor> redPieces, 
		...
		this.moveValidator = new EpsilonStrategyMoveValidator();
		this.moveResolver = new EpsilonStrategyMoveResolver();
